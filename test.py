...
class MyAppTestCase(unittest.TestCase):
    ...
    def test_read_document_markdown(self):
        ...
        self.assertIn('<h3>Document Proper:</h3>\n<h1>Title</h1>\n<h2>Subtitle</h2>\n<h3>Tagline</h3>\n<ul>\n<li>Bullet point</li>\n</ul>\n<p><em>Italic</em></p>\n<p><strong>Bold</strong></p>\n<p><strong><em>Both italic and bold</em></strong></p>', rv.data.decode('utf-8'))
    ...
    def test_approve_document(self):
        ...
        self.assertIn('Form submitted for', rv.data.decode('utf-8'))
    ...
    def test_view_category(self):
        ...
        self.assertIn('<li>', rv.data.decode('utf-8'))

    def test_access_denied(self):
        """Test that the access denied page is accessible"""
        rv = self.app.get('/accessdenied')
        self.assertIn('Access Denied', rv.data.decode('utf-8'))
    ...
    def test_access_denied_edit(self):
        ...
        self.assertIn('accessdenied', rv.data.decode('utf-8'))
